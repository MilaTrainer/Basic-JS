...
const arraySortInfo = (inputArray) => {
    ...
    inputArray.forEach(element => {
        // if (element !== 'number') {
        //     return answer = "Некоторые элементы не являются числами";
        // }

        if (element == 'number') {
            return answer = "Массив отсортирован по возрастанию";
        }

        if (element !== '') {
            return answer = "Массив отсортирован по убыванию";
        }
        if (element !== '') {
            return answer = "Массив не отсортирован";
        }
    }
    )
    return answer;
